...
use Symfony\Bundle\MakerBundle\DependencyInjection\CompilerPass\CompatibleCheckPass;
...
class MakerBundle extends Bundle
{
    public function build(ContainerBuilder $container)
    {
        ...
        $container->addCompilerPass(new CompatibleCheckPass(), PassConfig::TYPE_BEFORE_OPTIMIZATION, 11);
