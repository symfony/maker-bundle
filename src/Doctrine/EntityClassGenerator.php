...
class Generator
{
    ...
    public function __construct(FileManager $fileManager, string $namespacePrefix)
    {
        ...
        $this->rootTemplateDirectory = __DIR__.'/Resources/skeleton/';
    }
    ...
    private function addOperation(string $targetPath, string $templateName, array $variables)
    {
        ...
        if (!file_exists($templatePath)) {
            $templatePath = $this->rootTemplateDirectory.$templateName;
    ...
    {
        $this->rootTemplateDirectory = $rootTemplateDirectory;
    }
}
