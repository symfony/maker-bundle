...
final class EntityClassGenerator
{
    ...
    public function generateEntityClass(ClassNameDetails $entityClassDetails, bool $apiResource, bool $withPasswordUpgrade = false, bool $generateRepositoryClass = true, bool $broadcast = false, bool $includeExampleComments = true): string
    {
