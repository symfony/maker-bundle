...
final class MakeEntity extends AbstractMaker implements InputAwareMakerInterface
{
    ...
    public function configureCommand(Command $command, InputConfiguration $inputConf)
    {
        $command
            ...
            ->addOption('use-standalone-services', null, InputOption::VALUE_NONE, 'Create standalone repository services; use composition instead of inheritance.')
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator)
    {
        ...
        if (!$classExists) {
            ...
            $entityPath = $this->entityClassGenerator->generateEntityClass(
                ...
                true,
                $broadcast,
                $input->getOption('use-standalone-services')
            );
