...
final class MakeRegistrationForm extends AbstractMaker
{
    ...
    private function successMessage(ConsoleStyle $io, bool $emailVerification, string $userClass): void
    {
        ...
        if (!$emailVerification) {
            ...
            $closing[] = sprintf('%d) Run <fg=yellow>"%s make:migration"</> to generate a migration for the newly added <fg=yellow>%s::isVerified</> property.', $index++, CliTools::getCommandPrefix(), $userClass);
        }
