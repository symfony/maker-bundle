...
class MakeEntityLegacyTest extends MakerTestCase
{
    public function getTestDetails()
    {
        ...
        yield 'entity_regenerate_xml' => [MakerTestDetails::createTest(
            ...
            ->setArgumentsString('--regenerate')
            ->setFixtureFilesPath(__DIR__.'/../fixtures/legacy/MakeEntity/MakeEntityRegenerateXml')
            ->addReplacement(
        ...
        yield 'entity_xml_mapping_error_existing' => [MakerTestDetails::createTest(
            ...
            ->setFixtureFilesPath(__DIR__.'/../fixtures/legacy/MakeEntity/MakeEntityXmlMappingError')
            ->addReplacement(
                'config/packages/doctrine.yaml',
                'type: annotation',
                'type: xml'
