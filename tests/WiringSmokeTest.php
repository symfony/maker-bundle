...
/**
 * Boots the maker locator with EVERY maker, including deprecated ones —
 * loading those classes legitimately triggers their deprecations.
 *
 * @group legacy
 */
#[Group('legacy')]
class WiringSmokeTest extends TestCase
{
    /**
